...
const std::string OBJ_POS_KEY = "cs225a::object::pos";
...
void simulation(Sai2Model::Sai2Model* robot, Sai2Model::Sai2Model* object, Simulation::Sai2Simulation* sim, UIForceWidget *ui_force_widget)
{
	...
	while (fSimulationRunning) {
		...
		if (fRobotLinkSelect)
			...
			sim->setJointTorques(robot_name, command_torques - robot->_M*kvj*robot->_dq + g);
		...
		// add position offset in world.urdf file 
		obj_pos += obj_offset;
		camera_pos += robot_offset;
