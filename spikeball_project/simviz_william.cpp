...
// 		}
		...
		sim->setJointTorques(robot_names[0], command_torques[0] + g);
...
//		camera_pos += robot_offset;  // camera position/orientation is set to the panda's last link
		...
		// redis_data.at(2) = std::pair<string, string>(JOINT_ANGLES_KEY_2, redis_client.encodeEigenMatrixJSON(robot_1->_q));
		// redis_data.at(3) = std::pair<string, string>(JOINT_VELOCITIES_KEY_2, redis_client.encodeEigenMatrixJSON(robot_1->_dq));
		// redis_data.at(4) = std::pair<string, string>(JOINT_ANGLES_KEY_3, redis_client.encodeEigenMatrixJSON(robot_1->_q));
		// redis_data.at(5) = std::pair<string, string>(JOINT_VELOCITIES_KEY_3, redis_client.encodeEigenMatrixJSON(robot_1->_dq));
		// redis_data.at(6) = std::pair<string, string>(JOINT_ANGLES_KEY_4, redis_client.encodeEigenMatrixJSON(robot_1->_q));
		// redis_data.at(7) = std::pair<string, string>(JOINT_VELOCITIES_KEY_4, redis_client.encodeEigenMatrixJSON(robot_1->_dq));
